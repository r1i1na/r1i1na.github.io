...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=V5h6GDVrM3vHEy5FGfNSP7SykD') //申请key:https://api.nsmao.net
.then(response => {
if (!response.ok) {
...
return;
 ...
 if (welcomeInfoElement) {
     welcomeInfoElement.innerHTML =
         `欢迎来自 <b><span style="color: var(--efu-main)">${pos}</span></b> 的朋友！💖<br>你距我约 <b><span style="color: var(--efu-main)">${dist.toFixed(2)}</span></b> 公里！<br>我这（?）还蛮大的（bushi)，欢迎来我这玩～<br>Tip：<b><span style="font-size: 15px;">${posdesc}</span></b>`;
 }
}
